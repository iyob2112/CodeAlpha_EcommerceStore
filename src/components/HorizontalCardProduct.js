...
import { FaArrowLeftLong, FaArrowRightLong } from "react-icons/fa6";import { Link } from 'react-router-dom'
...
const HorizontalCardProduct = ({category, heading}) => {
  ...
  return (
    <div className=' mx-auto px-4 my-7 relative'>
           ...
           {   loading ? (
            ...
            data.map((product,index)=>{
                return(
                    <Link to={"product/"+product?._id} className='w-full min-w-[350px] md:min-w-[390px] max-w-[280px] md:max-w-[320px] h-36 bg-white rounded-sm shadow flex'>
